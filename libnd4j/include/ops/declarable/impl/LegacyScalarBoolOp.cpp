    ...
    namespace ops {
        ...
        Nd4jStatus LegacyScalarBoolOp::validateAndExecute(Context &block) {
            ...
            if (block.width() > 1) {
                ...
                NativeOpExecutioner::execScalarBool(block.launchContext(), opNum, x->getBuffer(), x->getShapeInfo(), x->specialBuffer(), x->specialShapeInfo(),
                ...
                NativeOpExecutioner::execScalarBool(block.launchContext(), opNum, x->getBuffer(), x->getShapeInfo(), x->specialBuffer(), x->specialShapeInfo(),z->getBuffer(), z->getShapeInfo(),z->specialBuffer(), z->specialShapeInfo(), _scalar.buffer(), _scalar.shapeInfo(), _scalar.specialBuffer(), _scalar.specialShapeInfo(),block.getTArguments()->data() + offset);
            }
